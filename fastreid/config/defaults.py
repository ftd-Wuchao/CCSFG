...
# ---------------------------------------------------------------------------- #
_C.MODEL.CVAE = CN()
_C.MODEL.CVAE.Latent_dim = 64
_C.MODEL.CVAE.ALPHA = 0.2
...
_C.MODEL.LOSSES.CCFA = CN()
_C.MODEL.LOSSES.CCFA.SCALE = 1.0
_C.MODEL.LOSSES.ID = CN()
_C.MODEL.LOSSES.ID.SCALE = 0.25
_C.MODEL.LOSSES.MCNL = CN()
_C.MODEL.LOSSES.MCNL.SCALE = 1.0
