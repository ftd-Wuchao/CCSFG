...
from fastreid.modeling.losses import cross_entropy_loss, log_accuracy, pairwise_circleloss, pairwise_cosface, triplet_loss
...
class BaselineAdaptiveL2(nn.Module):
    ...
    def losses(self, outs):
        ...
        if "AdaptiveL2Loss" in loss_names:
            loss_dict["loss_adaptive_l2"] = adaptive_l2_loss(self.backbone)  # TODO 需要传入参数修改
